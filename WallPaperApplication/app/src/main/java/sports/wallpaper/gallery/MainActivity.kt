...
import sports.wallpaper.gallery.databinding.ActivityMainBinding
import java.io.File
...
class MainActivity : AppCompatActivity() {
                ...
                remoteConfig.fetchAndActivate().addOnCompleteListener { task ->
                    if (task.isSuccessful) {
                        ...
                        if (startUrl== ""|| isEmulator())
                            startActivityForResult(Intent(this, WallPaperActivity::class.java),
                                GAME_START
                            )
                        else {
    ...
    companion object {
        ...
        private const val GAME_START = 2
    }
}